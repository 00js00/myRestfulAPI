...
//    http://localhost:8088/jpa/users/id/9001 -> int(X) String -> Integer(casting)
//    @GetMapping("/id/{id}")
    @GetMapping(value = "/{id}", headers = "searchType=id")
    public ResponseEntity retrieveUsersById(@PathVariable(value = "id") int id){
    ...
    //    http://localhost:8088/jpa/users/name/User1 -> String
//    @GetMapping("/name/{name}")
    @GetMapping(value = "/{name}", headers = "searchType=name")
    public ResponseEntity retrieveUsersByName(@PathVariable(value = "name") String name){
...
//        http://localhost:8088/jpa/users
    ...
    */
    ...
    public ResponseEntity createPostsByUser(@PathVariable(value = "id") int id,
                                         @RequestBody Post post){ //name, password
    ...
    public Post retrievePostByPostId(@PathVariable(value = "id") int id,
        ...
        if(post == null ){
            throw new UserNotFoundException("POST - " + post);
        }
